...
_VHS_Material.SetFloat("_OffsetPosY", _verticalOffset);
	...
	public void OnRenderImage(RenderTexture source, RenderTexture destination)
	{
		...
		_VHS_Material.SetFloat("_OffsetNoiseX", Random.Range(0f, 0.006f));
		_VHS_Material.SetTexture ("_SecondaryTex", _VHSNoise);
		float offsetNoise = _VHS_Material.GetFloat("_OffsetNoiseY");
		_VHS_Material.SetFloat("_OffsetNoiseY", offsetNoise + Random.Range(-0.0003f, 0.0003f));
		...
		{
			_VHS_Material.SetFloat("_OffsetPosY", Random.Range(-0.005f, 0.005f));
		}
